...
if (theme.background) {
    ...
    // Theme uses a CSS class for background/effects
    document.body.classList.add(theme.bodyClass);
    // Also add to widget for widget-mode compatibility (Crucial for PWA backgrounds)
    if (widget) {
...
// --- End of FINAL FIX in applyTheme function ---
  ...
  // NOTE: The previous logic for manually setting widget background properties
  // has been REMOVED as it was overriding the correct repeating CSS patterns.
